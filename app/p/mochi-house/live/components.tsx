...
import { PALETTE, FONTS, CATEGORY_COLOR, TONE_BG, type Category, type Memory } from "./data";
...
// Neobrutalist pill / button — coral filled or white outlined.
// Accepts href; renders Link when provided.
...
// Headline eyebrow chip: ☁ HELLO ☁ style
...
// Memory card (used in archive + home preview)
export function MemoryCard({ memory }: { memory: Memory }) {
  const cat = CATEGORY_COLOR[memory.category];
  return (
    <article
      style={{
        background: "#fff",
