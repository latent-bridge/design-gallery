...
import { MOCHI, PALETTE, FONTS } from "./data";
import { MochiUsa, Kumo } from "./components";

export default function MochiHouseLiveLayout({
  children,
}: {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 md:gap-3 flex-wrap">
        <NavPill href="/p/mochi-house/live"           label="おうち"   />
        <NavPill href="/p/mochi-house/live/schedule"  label="よてい"   />
        <NavPill href="/p/mochi-house/live/archive"   label="おもいで" />
        {today.isLive && (
          <span
