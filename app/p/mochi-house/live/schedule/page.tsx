import { MOCHI, PALETTE, FONTS, CATEGORY_COLOR } from "../data";
import {
  MochiButton,
  CategoryTag,
  EyebrowChip,
...
export default function MochiHouseSchedulePage() {
  return (
    <main className="max-w-[1040px] mx-auto px-5 md:px-10 relative">
      ...
      <div className="mt-10 flex gap-3 items-center flex-wrap">
        <MochiButton href="/p/mochi-house/live">おうちに もどる →</MochiButton>
        <MochiButton variant="outline" href="/p/mochi-house/live/archive">
          おもいでを みる
        </MochiButton>
      </div>
...
function ScheduleDay({
  ...
  return (
    ...
    >
      ...
      {/* decorative fusen on first non-off day */}
      {index === 0 && !isOff && (
        <div
          style={{
            position: "absolute",
