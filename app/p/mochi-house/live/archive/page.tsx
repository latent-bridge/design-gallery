...
import { MOCHI, PALETTE, FONTS, CATEGORY_COLOR, type Category } from "../data";
import { MemoryCard, EyebrowChip, Kumo, Onigiri } from "../components";
...
export default function MochiHouseArchivePage() {
